...
weeklyrev1.6.py is a pymol script which simplifies the task of
...
For now the code is quite disorganized but it works.
...
@bash-4.0$ easy_install feedparser@
@bash-4.0$ sudo yum install python-feedparser@
 
h2. Usage

To run the program just call it from the prompt:

 @bash-4.0$ ./weeklyrev1.6.py@
