...
for item in items:
    ...
    # http://stackoverflow.com/questions/5141559/unicodeencodeerror-ascii-codec-cant-encode-character-u-xef-in-position-0-o
...
## http://snippets.aktagon.com/snippets/208-How-to-parse-an-RSS-or-Atom-feed-with-Python-and-the-Universal-Feed-Parser-library
